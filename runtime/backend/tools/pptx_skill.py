...
# Prefer this standalone runtime's local node_modules. Fall back to global npm
# modules for compatibility with the original Docker image.
...
_NODE_PATHS = [str(LOCAL_NODE_MODULES)]
if _NPM_PREFIX:
    _NODE_PATHS.append(os.path.join(_NPM_PREFIX, "lib", "node_modules"))
NODE_PATH = os.pathsep.join(_NODE_PATHS)
