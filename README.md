...
- [Run the full Harness flow locally](docs/run_full_flow_locally.md)
...
This README is intentionally kept as real multi-line Markdown.
Keep headings, Mermaid blocks, shell snippets, and tables on separate lines.
This protects the GitHub raw view, rendered project homepage, and documentation alignment tests.
